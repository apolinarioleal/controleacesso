...
namespace controle.Controllers
{
    public class PerfilUsuariosController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var temAcesso = await Usuario_Tem_Acesso("Perfil do Usuario", _context);
        ...
        {
            ViewData["UserId"] = new SelectList(_context.ApplicationUser, "Id", "Nome");
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoUsuario,UserId")] PerfilUsuario perfilUsuario)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.ApplicationUser, "Id", "Nome", perfilUsuario.UserId);
